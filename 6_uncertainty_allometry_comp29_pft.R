...
####################################
# Getting below ground for all sites
...
save(biom.plot, file="processed_data/for_alex_dye/Comp_29_plot_bm_array_allom_spp.Rdata")
...
save(plot.bm, file="processed_data/for_alex_dye/Comp29_plot_bm_kg_m2_allom_spp.Rdata")
...
save(allom.uncert, file="processed_data/doe_allometry_uncertainty_comp29_pft.Rdata")
# ------------------------
