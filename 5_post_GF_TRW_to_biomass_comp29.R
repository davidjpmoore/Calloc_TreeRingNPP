...
library(car)
load("processed_data/allometries/allometries_29.Rdata")
allom.29 <- allom.temp
allometries <- allom.29
...
save(bm.array, file="processed_data/Biomass_Array_Tree_kgm-2_component29.RData")
...
write.csv(bm.tree, "processed_data/Biomass_Tree_kgm-2_component29.csv", row.names=F)
# ---------------------------------
...
write.csv(bm.plot2, "processed_data/Biomass_Plot_Total_kgm-2_component29.csv", row.names=F)
# ---------------------------------
...
write.csv(bm.pft2, "processed_data/Biomass_Plot_Species_kgm-2_comp29.csv", row.names=F)
# ---------------------------------
...
write.csv(bm.site.pft2, "processed_data/Biomass_Site_Species_kgm-2_comp29.csv", row.names=F)
...
write.csv(bm.site2, "processed_data/Biomass_Site_Total_kgm-2_comp29.csv", row.names=F)
