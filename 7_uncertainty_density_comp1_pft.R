...
load("processed_data/Biomass_Array_Tree_kgm-2_component1.RData") # loads plot-level bm.array
# ------------------------
...
save(dens.uncert, file="processed_data/doe_density_uncertainty_comp1.Rdata")
# ------------------------
